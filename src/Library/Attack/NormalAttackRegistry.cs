...
public static class NormalAttackRegistry
{
    ...
    private static readonly Dictionary<string, NormalAttack> NormalAttacks = new()
    {
        ...
        { "Hyper Voice", new NormalAttack("Hyper Voice",  90, PokemonType.Normal, 100) },
        ...
        { "Sand Attack", new NormalAttack("Sand Attack",  0, PokemonType.Ground, 100) },
        { "Sand Tomb", new NormalAttack("Sand Tomb",  65, PokemonType.Ground, 85) },
