...
namespace Library
{
    ...
    public class Pokemon
    {
        ...
        /// </summary>
        /// <param name="attackName">Nombre del ataque al cual se quiere acceder.</param>
        ...
        /// </summary>
        /// <param name="attackIdx">Corresponde al valor del índice del ataque al cual se quiere acceder.</param>
